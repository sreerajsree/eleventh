                    ...
                    <div class="col-12 col-md-8 order-1 order-md-0 align-self-md-end">
                        <div class="row py-3 py-sm-5 py-xl-9 justify-content-sm-center">
                            <div class="col-12 col-sm-10">
                                <h1 class="display-4  mb-4 text-dark">Branding</h1>
            ...
            <div class="container-fluid overflow-hidden">
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-6 align-self-md-end dots">
                        <div class="p-5">
                            <h2 class="display-7 mb-4 text-dark fw-bold">In addition to design, we offer a range of branding
                                services that help you build a strong and cohesive brand. This includes:</h2>
                            <h2 class="link-dark border-dark border-start border-5 p-3">Brand strategy
                                development: We'll work with you to define your brand positioning, value
                                proposition, and messaging strategy</h2>
                            <h2 class="link-dark border-dark border-start border-5 p-3">Brand research:
                                We'll conduct research to better understand your audience's needs, preferences, and
                                pain points.</h2>
                            <h2 class="link-dark border-dark border-start border-5 p-3">Brand identity
                            ...
                            <h2 class="link-dark border-dark border-start border-5 p-3">Brand

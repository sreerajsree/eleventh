                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="b-sale p-3">
                            ...
                            <h1 class="py-2">Ecommerce | Phone Cases</h1>
                            ...
                            <div>
                                <button class="btn btn-primary btn-sm">Ecommerce</button>
                                <button class="btn btn-primary btn-sm">Gadgets</button>
                            </div>
                            <table class="table my-5 font-man table-responsive table-dark table-striped">
                                <thead>
                                    <th>Site age</th>

                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-2">
                            <div class="p-3">
                                ...
                                <h3>USD $1,400,012</h3>
                                <a class="btn btn-primary" href="{{ route('contact') }}">Buy Now</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row justify-content-md-center gy-3 gy-xl-4">
                    <div class="col-12 col-md-11 col-lg-8 col-xl-7 col-xxl-6 gy-3 gy-xl-4 bsb-entry-content">
                        <p class="lead">If you have any brand you want to list for sale on our website, please get in touch with us.</p>

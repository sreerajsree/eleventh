    ...
    <main id="main">
        ...
        <section class="bg-black">
            <div class="row align-items-center p-0 m-0">
                ...
                <div class="col-md-6 p-0">
                    <img class="img-fluid"
                        src="https://static.showit.co/1600/jcTPjhI1TFO0X2juwz1-_A/65041/vip-design-day-saffron-avenue-branding-websites-0.jpg"
                        alt="">
                </div>
            </div>
        </section>
        <section style="background-color: #F8F7F5">
            <div class="container">
                <div class="text-center w-fifty mx-auto p-4">
                    <h2 class="fst-italic mb-5">The Breakdown</h2>
                    <p class="fs-8">01</p>
        ...
        <section class="bg-black">
            <div class="vh-100 card border-0 rounded-0  overflow-hidden text-center bsb-overlay"
                style="background-image: url('https://static.showit.co/1600/s5TH2Cm7RIic3jNDLe3Jrw/65041/saffron-avenue-brand-design-showit-website-templates-1500.jpg'); --bsb-overlay-opacity: .4; background-size:cover;background-position: 50% 50%;background-repeat: no-repeat;">
                <div class="card-body container text-white d-flex align-items-center">

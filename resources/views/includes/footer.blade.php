    ...
    <section>
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="col-12 col-md-11 col-xl-10">
                            ...
                            <div class="mt-3">
                                <p>Founded by award winning entrepreneur, Ameerah,
                                    who owns a portfolio of multi million dollar e-commerce brands.</p>
                                <p>We bring your a solution to any and every barrier you may face as a business owner
                                </p>
                            </div>
                            <div class="social-media-wrapper my-4">
                                <ul class="nav">
                                    <li class="nav-item me-3">
                                        <a class="nav-link link-primary pe-2 p-0 rounded footer-icon" href="#!"
                                            title="Facebook">
                ...
                <div class="col-12 col-lg-8  border-top bsb-tpl-border-lg-cyan py-5 foot-back">
                                                ...
                                                <div class="col-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="email" class="form-control"
                                                            id="email-newsletter" name="email"
